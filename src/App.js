...
import { Button, Image, Grid, Icon, Container } from 'semantic-ui-react';
...
class App extends Component {
  ...
  render () {
    ...
    const userInfo = user ? (<div><Image src={user.photoURL} avatar />
    <span>{user.displayName}</span></div>) : null;
